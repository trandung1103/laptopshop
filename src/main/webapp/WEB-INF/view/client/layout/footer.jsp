            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <a href="#">
                        ...
                        <p class="text-secondary mb-0">Lãi suất 0%</p>
                    </a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    <h4 class="text-light mb-3">Tại sao nên mua hàng tại Laptopshop ?</h4>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="btn-link" href="">Thông tin</a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Địa chỉ: 20 ĐCT Pháp Vân - Cầu Giẽ, Tứ Hiệp,Q. Hoàng Mai, Hà Nội</p>
                    <p>Email: d.kienquoc@outlook.com</p>
                    <p>Phone: 0395462146</p>
